...
```{r}
hotsprings <- data.frame(temp_C = temp, name = name, spring = spring)
print(hotsprings)
```
...
```{r}
hotsprings <- data.frame(temp_c = temp, scientist = name, spring = spring)
hotsprings
```
